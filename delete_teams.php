            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        echo "<tr><td>" . $row["id"]. "</td><td>" . $row["name"]. "</td><td>" . $row["description"]. "</td><td>" . $row["created_at"]. "</td>";
                        echo "<td><a href='delete_team_process.php?id=" . $row["id"] . "' class='btn btn-danger'>Delete</a></td></tr>";
                    }
                } else {
                    echo "<tr><td colspan='5'>Aucune équipe trouvée</td></tr>";
                }
                ?>
            </tbody>
        </table>
